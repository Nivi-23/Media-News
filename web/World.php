...
<style>
  ...
  <title>News Media-World News</title>
  <meta charset="utf-8">
          ...
          <div class="col-md rows">
              ...
              <h3>World News</h3>
                <div class='card-columns'>
                    <?php
                            $sql = 'select * from news where type="World" order by newsdate desc limit 30';
...
<?php
            ...
            else
            {
              echo'uploaded soonn......';
                  ...
                  <?php
              $sql = 'select * from news where type="Entertainment" order by newsdate desc limit 5';
            $res = mysqli_query($conn,$sql);
                $result=mysqli_num_rows($res);
            If($result>0)
            {
