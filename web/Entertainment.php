  ...
  <div class="container-fluid" style="margin-top:55px;  padding: 20px; background-color: #FFF;" class="bg-dark">
      <div class="row">
          ...
          <div class="col-md rows">
               ...
               <a href="Entertainment.php" class="titles"><h3>Entertainment News</h3></a>
                <div class='card-columns'>
                    <?php
                            $sql = 'select * from news where type="Entertainment" order by newsdate desc limit 30';
...
<?php
            ...
            else
            {
              echo'uploaded soonn......';
                  ...
                  <?php
              $sql = 'select * from news where type="World" order by newsdate desc limit 5';
            $res = mysqli_query($conn,$sql);
                $result=mysqli_num_rows($res);
            If($result>0)
            {
